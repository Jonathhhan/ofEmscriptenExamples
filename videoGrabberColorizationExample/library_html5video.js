        ...
        update: function(updatePixels, video, context, dstPixels){
        	if((updatePixels || video.pixelFormat!="RGBA") && video.width!=0 && video.height!=0 && dstPixels!=0){
        		...
        		context.drawImage( video, 0, 0, video.width, video.height );
	            	...
	            	}else if(video.pixelFormat=="RGB" && typeof edges2pikachu != "undefined"){	
				edges2pikachu.transfer(context.canvas, result => {
							imageData = result.getImageData(0, 0, video.width, video.height);
