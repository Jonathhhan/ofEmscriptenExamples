...
void ofApp::setup(){
	...
	ofClear(255,255,255, 0);
	rgbaFboFloat.end();
	toggle_1.setup(780, 475, 20);
	toggle_2.setup(780, 500, 20);
	ofAddListener(toggle_1.onMousePressed, this, & ofApp::toggle_1_event);
	ofAddListener(toggle_2.onMousePressed, this, & ofApp::toggle_2_event);
...
void ofApp::drawFboTest(){
	...
	ofFill();
	ofSetColor(100,34,255, fadeAmnt);
...
void ofApp::draw(){
	...
	ofDrawBitmapString("Record window ", 660, 490);
	ofDrawBitmapString("Record texture ", 660, 515);
	toggle_1.draw();
	toggle_2.draw();
	if (isDrawingTexture) {
