...
ofEvent<std::string> loadTitleEvent;
...
//--------------------------------------------------------------
void ofApp::bang_4_event(bool & e) { 
	EM_ASM(
	var title = prompt("Please enter a title:", "Import.");
	if (title != null) {
		Module.loadTitle(title.substring(0, 22));
	}
	);
}

void loadTitle(std::string string) {
	loadTitleEvent.notify(string); 
}

void ofApp::loadTitleX(std::string & string) {
	title = string;
}
...
EMSCRIPTEN_BINDINGS(Module) {
	...
	emscripten::function("loadTitle", & loadTitle);
}
...
void ofApp::setup() {
	...
	ofAddListener(bang_4.onMousePressed, this, & ofApp::bang_4_event);
	...
	ofAddListener(loadTitleEvent, this, & ofApp::loadTitleX);
	bang_1.setup(40, 160, 20);
	bang_2.setup(40, 185, 20);
	bang_3.setup(40, 210, 20);
	bang_4.setup(40, 135, 20);
	toggle_1.setup(40, 235, 20);
	label_1.setup(40, 40, 205, 75, "");
	label_2.setup(145, 135, 100, 20, "Load title");
	label_3.setup(145, 160, 100, 20, "Load audio");
	label_4.setup(145, 185, 100, 20, "Load video");
	label_5.setup(145, 210, 100, 20, "Load image");
	label_6.setup(145, 235, 100, 20, "Pause");
	label_7.setup(145, 260, 100, 20, "Position");
	label_8.setup(145, 285, 100, 20, "0");
	label_9.setup(145, 310, 100, 20, "Panorama");
	label_10.setup(145, 335, 100, 20, "0");
	label_11.setup(145, 360, 100, 20, "Volume");
	label_12.setup(145, 385, 100, 20, "0.5");
